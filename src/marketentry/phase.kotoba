(ns marketentry.phase
  "Phase 0->3 staged rollout for the Guyana (GUY) market-entry
  compliance actor.
  ...
  real portal package (npta.gov.gy Register-of-Bidders submission) and
  submitting a real registration/filing are the two real-world acts
  this actor performs; both are always a human market-entry operator's
  call. `marketentry.governor`'s `:actuation/draft-filing`/
