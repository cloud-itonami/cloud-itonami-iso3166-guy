...
`cloud-itonami-iso3166-guy` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
Guyana-licensed counsel or a registered agent for whatever licensed
representation the law of Guyana requires for public-procurement
filings.
